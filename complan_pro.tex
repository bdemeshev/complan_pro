...
\begin{problem}
Теорема Боттемы. Рассмотрим произвольный треугольник $\triangle ABC$. 
На сторонах $AB$ и $BC$ отложены два квадрата, $ABDE$ и $BCFG$. 
На середине отрезка $EF$ отмечена точка $P$.
...
\begin{problem}
Теорема Ван-Обеля. Рассмотрим произвольный выпуклый четырёхугольник $ABCD$. 
